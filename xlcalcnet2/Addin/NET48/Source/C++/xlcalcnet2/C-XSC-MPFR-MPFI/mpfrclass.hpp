...
//		friend void set_Mpfr(MpfrClass&, const MpfrClass&, RoundingMode = CurrRndMode, PrecisionType = CurrPrecision);
	...
	// Change by DH : lower case for round, floor, trunc, ceil, frac
