...
namespace ArbPrecNet
{
    ...
    public partial class aflint
    {
        ...
        public static int mat_rows(ArbMat matA)
        {
            return matA.rows;
        }
        ...
        public static int mat_cols(ArbMat matA)
        {
            return matA.cols;
        }
        ...
        /// <include file="docs.xml" path='docs/members[@name="Eigen"]/mat_cols/*' />
        public static int mat_size(ArbMat matA)
        {
            return matA.size;
        }
        ...
        public static ArbMat mat_get_block(ArbMat matA, int i, int j, int p, int q)
        {
        ...
        public static void mat_set_block(ArbMat matA, int i, int j, int p, int q, ArbMat matB)
        {
        ...
        public static ArbMat mat_get_row(ArbMat matA, int i)
        {
        ...
        public static void mat_set_row(ArbMat matA, int i, ArbMat matB)
        {
            matA.set_Row(i, matB);
        }
        ...
        public static ArbMat mat_get_col(ArbMat matA, int i)
        {
        ...
        public static void mat_set_col(ArbMat matA, int i, ArbMat matB)
        {
            matA.set_Col(i, matB);
        }
        ...
        public static ArbMat mat_get_diagonal(ArbMat matA, int q = 0)
        {
        ...
        public static void mat_set_diagonal(ArbMat matA, int q, ArbMat matB)
        {
        ...
        public static ArbMat mat_get_triangular_view(ArbMat matA, int view = 1)
        {
        ...
        public static void mat_set_triangular_view(ArbMat matA, int view, ArbMat matB)
        {
        ...
        public static void mat_sort(ArbMat matA, int sort_order = 0, int sort_criterion = 1)
        {
        ...
        public static void mat_sort_rows_by_col(ArbMat matA, int column_to_sort_by = 0, int sort_order = 0, int sort_criterion = 1)
        {
        ...
        public static void mat_resize(ArbMat matA, int r, int c)
        {
            matA.Resize(r, c);
        }
        ...
        public static void mat_resize_like(ArbMat matA, ArbMat matB)
        {
        ...
        public static void mat_conservative_resize(ArbMat matA, int r, int c)
        {
        ...
        public static ArbMat mat_as_diagonal(ArbMat matA)
        {
        ...
        public static ArbMat mat_adjoint(ArbMat matA)
        {
            return matA.Adjoint();
        }
        ...
        public static ArbMat mat_conjugate(ArbMat matA)
        {
        ...
        public static ArbMat mat_transpose(ArbMat matA)
        {
        ...
        public static ArbMat mat_reverse_full(ArbMat matA)
        {
        ...
        public static ArbMat mat_reverse_row_wise(ArbMat matA)
        {
        ...
        public static ArbMat mat_reverse_col_wise(ArbMat matA)
        {
        ...
        public static ArbMat mat_replicate_full(ArbMat matA, int vertical, int horizontal)
        {
        ...
        public static ArbMat mat_replicate_row_wise(ArbMat matA, int horizontal)
        {
        ...
        public static ArbMat mat_replicate_col_wise(ArbMat matA, int vertical)
        {
        ...
        public static ArbMat mat_concat_horizontal(ArbMat matA, ArbMat matB)
        {
        ...
        public static ArbMat mat_concat_vertical(ArbMat matA, ArbMat matB)
        {
        ...
        //public static ArbMat mat_sum(ArbMat matA, int partialmode)
        //{
        ...
        //public static ArbMat mat_prod(ArbMat matA, int partialmode)
        //{
        ...
        //public static ArbMat mat_mean(ArbMat matA, int partialmode)
        //{
        ...
        //public static ArbMat mat_min_coeff(ArbMat matA, int partialmode)
        //{
        ...
        //public static ArbMat mat_max_coeff(ArbMat matA, int partialmode)
        //{
        ...
        //public static Double mat_trace(ArbMat matA, int partialmode)
        //{
        ...
        //public static ArbMat mat_squared_norm(ArbMat matA, int partialmode)
        //{
        ...
        //public static ArbMat mat_norm(ArbMat matA, int partialmode)
        //{
        ...
        //public static ArbMat mat_stable_norm(ArbMat matA, int partialmode)
        //{
        ...
        //public static ArbMat mat_covariance(ArbMat matA)
        //{
        ...
        public static ArbMatMap mat_ldlt(ArbMat matA, string query, ArbMat matB)
        {
        ...
        public static ArbMatMap mat_partial_piv_lu(ArbMat matA, string query, ArbMat matB)
        {
        ...
        public static ArbMatMap mat_full_piv_lu(ArbMat matA, string query, ArbMat matB)
        {
        ...
        //public static ArbMatMap mat_llt(ArbMat matA, string query, [Optional] ArbMat matB)
        //{
        ...
        /// <include file="docs.xml" path='docs/members[@name="Eigen"]/mat_llt/*' />
        public static ArbMatMap mat_llt(ArbMat matA, string query, ArbMat matB)
        {
            return matA.LLT(query, matB);
        }
        ...
        public static ArbMatMap mat_householder_qr(ArbMat matA, string query, ArbMat matB)
        {
        ...
        public static ArbMatMap mat_col_piv_householder_qr(ArbMat matA, string query, ArbMat matB)
        {
        ...
        public static ArbMatMap mat_full_piv_householder_qr(ArbMat matA, string query, ArbMat matB)
        {
        ...
        public static ArbMatMap mat_cod_householder_qr(ArbMat matA, string query, ArbMat matB)
        {
