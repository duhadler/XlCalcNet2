...
namespace ArbPrecNet
{
    ...
    public class dflint
    {
        ...
        public static dflintc cplxctx
        {
            get { return new dflintc(); }
        }
